...
title:
  ...
  de: Immer wissen, wo man ist
case: wurzel
businessGoal:
  en: Give explicit navigation — back/forward and a breadcrumb of the ownership hierarchy — so a non-technical user never feels lost.
  de: Explizite Navigation bieten — Zurück/Vor und ein Breadcrumb der Besitz-Hierarchie — damit ein nicht-technischer Nutzer sich nie verloren fühlt.
priority: must
status: done
aiContribution:
