---
title:
  en: Create and revise offers from positions
  de: Angebote aus Positionen erstellen und überarbeiten
case: wurzel
businessGoal:
  en: Build an offer from a project's positions, see its total, edit it, and keep multiple revised versions per project.
  de: Ein Angebot aus den Positionen eines Projekts bauen, seine Summe sehen, es bearbeiten und je Projekt mehrere überarbeitete Versionen führen.
priority: must
status: done
aiContribution:
