...
fitCriterion:
  en: Typing 3+ characters into a Street field anywhere it appears offers real address suggestions that fill Street/PostalCode/City together; a “Create project”/“Create offer” button on the customer screen reaches a saved project/offer without visiting any other screen first, and an abandoned in-progress offer draft leaves no orphan project or position behind.
