...
tool: Mermaid
caption:
  en: "The documented project states. At Level 1 a project is created as Open; user-driven status change is Level 2. A closed project is read-only."
  de: "Die dokumentierten Projektzustände. Auf Level 1 wird ein Projekt als Offen angelegt; die nutzergesteuerte Statusänderung ist Level 2. Ein geschlossenes Projekt ist nur lesbar."
aiContribution:
...
code:
  ...
  de: |
    stateDiagram-v2
      ...
      state "Geschlossen" as Geschlossen
      [*] --> Offen
      Offen --> InBearbeitung
      InBearbeitung --> Geschlossen
      Offen --> Geschlossen
      Geschlossen --> [*]
---
