...
code:
  ...
  de: |
    classDiagram
      ...
      OfferItem "0..1" --> "1" OfferPositionSnapshot : eingefroren als
      Offer "0..1" --> "1" Offer : Vorgänger
      class Customer {
        Kundennummer yyyy-nnn
        Name, Adresse
      }
      class Project {
        Projektnummer yyyy-nnn
      ...
      class Offer {
        ...
        Zustand Offen/Ersetzt
        Betreff, Vorgaenger-Id
      }
---
