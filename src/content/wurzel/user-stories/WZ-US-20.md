---
title:
  en: Auto-capitalise names and text on blur
...
soThat:
  en: documents look professional without me fixing capitalisation by hand
  de: Dokumente professionell wirken, ohne dass ich die Groß-/Kleinschreibung von Hand korrigiere
requirement: WZ-R-07
acceptanceCriteria:
  en:
    - On blur, names (FirstName, LastName, Company, City, Street) get word-caps; free text (ProjectName, Description, Subject, Notes) gets sentence-caps
    - Inner capitals are preserved (e.g. GmbH); Email, Phone, PostalCode, numeric and tax/bank fields are excluded
...
status: done
aiContribution:
  en: The idea came from the recorded session (“Soll ich was einbauen, das automatisch groß schreibt? Ja.” — should I build something that capitalises automatically? Yes.); the AI proposed the word- vs sentence-caps split and the field exclusions. I confirmed preserving inner capitals like GmbH.
