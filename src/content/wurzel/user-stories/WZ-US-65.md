...
acceptanceCriteria:
  ...
  de:
    ...
    - "Nach einem solchen Speichern sieht die Nutzerin einen deutschen Hinweis, der benennt, was sich geändert hat: die Position, ihre neue Menge und jedes Angebot, dessen Summe sich mitbewegt"
    ...
    - "Jedes vom Server abgelehnte Speichern einer Rechnung zeigt der Nutzerin eine deutsche Begründung am Bildschirm — kein Speichern scheitert wortlos"
