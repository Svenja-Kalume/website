...
iWant:
  ...
  de: "einen Teil eines laufenden Projekts abzurechnen, indem ich die Positionen und Mengen auswähle, die ich jetzt in Rechnung stelle"
soThat:
  en: "money comes in during the job instead of only at the end"
  de: "während des Auftrags Geld herein kommt und nicht erst am Ende"
requirement: WZ-R-12
acceptanceCriteria:
  en:
  ...
  de:
    ...
    - "Auswählbar sind nur Positionen, die nicht deaktiviert sind und noch eine Restmenge haben; eine vollständig abgerechnete Position wird ausgegraut gezeigt, nicht ausgeblendet"
