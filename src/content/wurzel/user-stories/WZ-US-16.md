---
title:
  en: Preview the open offer in the project view
...
iWant:
  ...
  de: die Kerndaten des offenen Angebots in der Projektansicht zu sehen
soThat:
  en: I can review the active quote without navigating away
  de: ich das aktive Angebot prüfen kann, ohne wegzunavigieren
requirement: WZ-R-04
acceptanceCriteria:
  en:
  ...
  de:
    ...
    - Existiert ein offenes Angebot, bietet sie „Neue Version“ und „Bearbeiten“; sonst „Kein offenes Angebot vorhanden“ und „Neu“ (nur wenn das Projekt gespeichert ist)
    - Die Vorschau ist schreibgeschützt — keine Positionen, nichts editierbar
priority: must
status: done
aiContribution:
